...
const HEPBURN_MACRON_RANGES: [[u32; 2];5] = [
  [0x0100, 0x0101], // Ā ā
  [0x0112, 0x0113], // Ē ē
  [0x012a, 0x012b], // Ī ī
  [0x014c, 0x014d], // Ō ō
...
const SMART_QUOTE_RANGES: [[u32; 2];2] = [
  [0x2018, 0x2019], // ‘ ’
  [0x201C, 0x201D], // “ ”
];

const SMART_QUOTE_RANGES2: [[u32; 2];2] = [
...
const JA_PUNCTUATION_RANGES: [[u32; 2];8] = [
...
pub const LONG_VOWELS: phf::Map<&'static str, &'static str> = phf_map! {
  "a" => "あ",
  "i" => "い",
  "u" => "う",
  "e" => "え",
...
pub const FOUR_CHAR_EDGECASES: &'static [&'static str] = &[
  "lts",
  "chy",
  "shy",
];
...
static TO_ROMAJI: phf::Map<&'static str, &'static str> = phf_map! {
  "　" => " ",
  "！" => "!",
  "？" => "?",
  "。" => ".",
